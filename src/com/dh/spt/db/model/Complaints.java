...
public class Complaints implements java.io.Serializable {
	...
	private Set<ComplaintImages> complaintImageses = new HashSet<ComplaintImages>(
			0);
	...
	public Complaints(ComplaintTypes complaintTypes, String incidentId,
			...
			String reportedLocation, Set<ComplaintImages> complaintImageses) {
		...
		this.complaintImageses = complaintImageses;
	}
	...
	public Set<ComplaintImages> getComplaintImageses() {
		return this.complaintImageses;
	}

	public void setComplaintImageses(Set<ComplaintImages> complaintImageses) {
		this.complaintImageses = complaintImageses;
	}
